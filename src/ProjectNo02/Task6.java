...
class Registration{
    ...
    public void setPassword(String password) {
        if(!password.isEmpty()&&password.length()>6&&!password.contains(userName)) {
            ...
            System.out.println("Password cannot contain username or  be empty and must be larger than 6 characters .");
        }
    }
    ...
    public static void main(String[] args) {
        ...
        user.setUserName("marley123");
        user.setPassword("jamaica89");
    }
}